...
const index = () => {
  return (
    <div className={cx('container')}>
        ...
        <Image src= {YHDT} alt="YHDT" width='1000' height='500' className='image'/>
        ...
        <Image src={YHCY} alt="YHCY" width='1000' height='500' className='image'/>
        ...
        <p><strong><em>Giai đoạn 1982-1991</em></strong></p>
